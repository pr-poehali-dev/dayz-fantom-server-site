...
const RULES = [
  ...
  { num: "02", title: "Уважение игроков", desc: "Оскорбления, расизм и харассмент в чате недопустимы." },
  { num: "03", title: "Рейдинг", desc: "Рейдить базы разрешено. Удаление фундаментов новичков запрещено." },
